...
##D ## https://www.census.gov/population/metro/files/lists/historical/90nfips.txt
##D ## 1123		Boston-Lawrence-Salem-Lowell-Brockton, MA NECMA
##D ## 1123 25 009	  Essex County
##D ## 1123 25 017	  Middlesex County
##D ## 1123 25 021	  Norfolk County
##D ## 1123 25 023	  Plymouth County
##D ## 1123 25 025	  Suffolk County
...
##D # proj4string(house) <- CRS("+proj=longlat +ellps=GRS80")
##D # library(rgdal)
