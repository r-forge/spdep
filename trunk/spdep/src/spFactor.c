...
static char RCSid[] =
    "@(#)$Header: /home/rsb/tmp/SPDEP_CVS_SVN/spdep/src/spFactor.c,v 1.2 2002-08-20 07:12:21 rsb Exp $";
#endif
*/
...
/* RSB 2002-02-12 added declarations */
    
void spcRowExchange(MatrixPtr, int, int);
void spcColExchange(MatrixPtr, int, int);
void spcLinkRows(MatrixPtr);
static void ComplexRowColElimination(MatrixPtr, register ElementPtr);
static void RealRowColElimination(MatrixPtr, register ElementPtr);
...
static RealNumber 
    FindBiggestInColExclude(MatrixPtr, register ElementPtr, register int);
static void 
    ExchangeRowElements(MatrixPtr, int, register ElementPtr, int,
		   register ElementPtr, int);
static void 
    ExchangeColElements(MatrixPtr, int, register ElementPtr, int,
		   register ElementPtr, int);
...
/* Perform reordering and factorization. */
    ...
    {   pPivot = SearchForPivot( Matrix, Step, DiagPivoting );
        if (pPivot == NULL) return (int) MatrixIsSingular( Matrix, Step );
...
static void /* RSB 2002-02-12 added void */
CreateInternalVectors( Matrix )
...
void /* RSB 2002-02-12 added void */
...
/*extern RSB 2002-02-12 */ ElementPtr  CreateFillin();
