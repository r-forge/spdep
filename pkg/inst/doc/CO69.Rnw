...
constant for each measure, the sqare root of the variance of the measure
...
save(zzz, MoranNb, MoranRb, Prop_unstdNb, Prop_unstdRb, Prop_stdNb, Prop_stdRb, file="backstore/boot_res.RData")
@
<<echo=FALSE,eval=TRUE>>=
