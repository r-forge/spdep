...
@ 
<<label=choymap,fig=FALSE,echo=TRUE,eval=FALSE>>= 
spplot(nc, c("ch_pmap_low", "ch_pmap_high"), at=c(0, 0.001, 0.01, 0.05, 0.1, 1), col.regions=grey.colors(5))
@
\end{footnotesize}
...
@ 
<<label=poismap,fig=FALSE,echo=TRUE,eval=FALSE>>= 
...
@
<<label=poismap2,fig=FALSE,echo=TRUE,eval=FALSE>>= 
...
@
<<label=EBlocal,fig=FALSE,echo=TRUE,eval=FALSE>>= 
...
@ 
<<label=LMmap,fig=FALSE,echo=TRUE,eval=FALSE>>= 
...
@
<<label=fitIV,fig=FALSE,echo=TRUE,eval=FALSE>>= 
