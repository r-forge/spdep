...
```{r, echo=dothis, eval=dothis}
try(NY8_sp_old_1_nb <- poly2nb(NY8_sp_old))
...
```{r, echo=dothis, eval=dothis}
try(NY8_sp_old_1_nb_buf <- poly2nb(NY8_sp_old_buf))
...
```{r, echo=dothis, eval=dothis}
try(NY8_sf_old_1_sgbp <- st_queen(NY8_sf_old))
```
...
```{r, echo=dothis, eval=dothis}
try(NY8_sf_old_1_nb_buf <- st_queen(NY8_sf_old_buf))
